...
exports.useBaseEdit = function (refForm, initialState, service, p1, p2) {
  return exports.useBaseEditProps(null, refForm, initialState, service, p1, p2);
};
exports.useBaseEditProps = function (props, refForm, initialState, service, p1, p2, p3) {
  var p4 = (p2 ? p2 : {});
  var p = {
    props: props,
    refForm: refForm,
  ...
  return exports.useBaseEditOneProps(p);
};
...
exports.useEditOne = function (p) {
  var baseProps = exports.useBaseEditOneProps(p);
...
exports.useBaseEditOneProps = function (p) {
  ...
  var baseProps = base_1.useBase(p.initialState, p.getLocale);
  ...
  }), editState = _e[0], setEditState = _e[1];
  ...
  var resetState = function (newMode, model, originalModel) {
    setEditState({ newMode: newMode, originalModel: originalModel });
    showModel(model);
  };
  ...
  var _onSave = function (isBack) {
    if (editState.newMode === true && editState.addable === false) {
      ...
      if (editState.newMode) {
        ...
        var diffObj_1 = reflectx_1.makeDiff(edit_1.initPropertyNullInModel(editState.originalModel, metadata), obj_1, p.keys, p.version);
  ...
  var _succeed = function (msg, isBack, result) {
    if (!p.version && p.service && p.service.metadata) {
      var m = (p.metadata ? p.metadata : p.service.metadata());
    ...
    if (result) {
      ...
      if (model && editState.setBack === true) {
        ...
        edit_1.handleVersion(getModel(), p.version);
      }
    }
    else {
      edit_1.handleVersion(getModel(), p.version);
  ...
  var _postSave = function (res, backOnSave) {
    setRunning(false);
    if (p.loading) {
  ...
  var _save = function (obj, body, isBack) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          if (!(editState.newMode === false)) return [3, 5];
      ...
      switch (_a.label) {
        ...
        case 2:
          ...
          if (!obj) {
            ...
            setEditState({ newMode: false, originalModel: reflectx_1.clone(obj) });
            if (callback) {
  ...
  return __assign(__assign({}, baseProps), { back: back, refForm: p.refForm, ui: p.ui, resource: p.resourceService.resource(), editState: editState,
    running: running,
