...
var ViewComponent = (function (_super) {
  ...
  function ViewComponent(props, sv, param, showError, getLocale, loading) {
    var _this = _super.call(this, props, input_1.getLocaleFunc(param, getLocale)) || this;
...
var SearchComponent = (function (_super) {
  ...
  SearchComponent.prototype.call = function (s) {
    return __awaiter(this, void 0, void 0, function () {
      var ctx, sr, sr, err_2;
      return __generator(this, function (_a) {
        switch (_a.label) {
