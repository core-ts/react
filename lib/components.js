...
var BaseSearchComponent = (function (_super) {
  ...
  BaseSearchComponent.prototype.getFields = function () {
    var fs = search_utilities_1.getFieldsFromForm(this.fields, this.initFields, this.form);
  ...
  BaseSearchComponent.prototype.validateSearch = function (se, callback) {
    ...
    search_utilities_1.validate(se, callback, this.getSearchForm(), state_1.localeOf(undefined, this.getLocale), vl);
  };
