...
function updateUrl(filter, isFirstLoad, setFilter, state, setState) {
  if (state) {
...
function setSortFilter(state, filter, setFilter, search) {
...
function onPageSizeChanged(e, search, filter) {
  filter.page = 1
...
function onSearch(e, search, filter, state) {
  e.preventDefault()
  filter.page = 1
  if (state) {
...
function sortOnChange(target, search, filter) {
  filter.sort = target.value
  search(filter)
}
exports.sortOnChange = sortOnChange
function onSort(e, search, filter, state) {
