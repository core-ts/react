...
var BaseSearchComponent=(function(_super){
  ...
  function BaseSearchComponent(props, resourceService, ui, showMessage, showError, getLocale, listFormId){
...
var SearchComponent=(function(_super){
  ...
  function SearchComponent(props, service, resourceService, ui, showMessage, showError, getLocale, loading, autoSearch, listFormId){
    var _this = _super.call(this, props, resourceService, ui, showMessage, showError, getLocale, listFormId) || this;
    _this.service = service;
    _this.loading = loading;
