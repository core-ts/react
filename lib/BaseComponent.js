...
var ViewComponent=(function (_super){
  ...
  function ViewComponent(props, param, resourceService, showError, getLocale, loading){
  ...
  ViewComponent.prototype.getModelName=function (){
    ...
    if (this.form){
      var a=this.form.getAttribute('model-name');
      if (a && a.length > 0){
        return a;
      }
...
var BaseComponent=(function (_super){
  ...
  function BaseComponent(props, resourceService, ui, getLocale, loading){
    var _this=_super.call(this, props, resourceService, getLocale) || this;
    _this.loading=loading;
...
var BaseSearchComponent=(function (_super){
  ...
  function BaseSearchComponent(props, resourceService, ui, showMessage, getLocale, listFormId){
    var _this=_super.call(this, props, resourceService, ui, getLocale) || this;
    _this.ui=ui;
...
var SearchComponent=(function (_super){
  ...
  function SearchComponent(props, param, resourceService, ui, showMessage, showError, getLocale, loading, autoSearch, listFormId){
    var _this=_super.call(this, props, resourceService, ui, showMessage, getLocale, listFormId) || this;
    _this.showError=showError;
    _this.loading=loading;
      ...
      return __generator(this, function (_a){
        switch (_a.label){
          case 0:
            ...
            return [4, this.searchFn(s, ctx)];
          case 1:
            sr=_a.sent();
            this.showResults(s, sr);
            return [3, 4];
          case 2: return [4, this.service.search(s, ctx)];
          case 3:
            sr=_a.sent();
            this.showResults(s, sr);
            _a.label=4;
...
var BaseEditComponent=(function (_super){
  ...
  function BaseEditComponent(props, resourceService, ui, showMessage, showError, confirm, getLocale, loading, patchable, backOnSaveSuccess){
    var _this=_super.call(this, props, resourceService, ui, getLocale, loading) || this;
    _this.ui=ui;
    _this.showMessage=showMessage;
    _this.showError=showError;
...
var EditComponent=(function (_super){
  ...
  function EditComponent(props, service, resourceService, ui, showMessage, showError, confirm, getLocale, loading, patchable, backOnSaveSuccess){
    var _this=_super.call(this, props, resourceService, ui, showMessage, showError, confirm, getLocale, loading, patchable, backOnSaveSuccess) || this;
  ...
  EditComponent.prototype.load=function (_id){
    return __awaiter(this, void 0, void 0, function (){
      var id, ctx, obj, err_3, data, r, title, msg, obj;
      return __generator(this, function (_a){
        switch (_a.label){
          case 0:
            id=_id;
          ...
          case 3:
            ...
            if (data && data.status===404){
              ...
              if (data.status && !isNaN(data.status)){
                msg=core_1.messageByHttpStatus(data.status, r);
              }
              if (data.status===403){
